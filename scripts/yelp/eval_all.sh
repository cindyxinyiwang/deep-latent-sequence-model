...
$SCRIPT/translate_yelp.sh $1 data/yelp/test_li.txt data/yelp/test_li.attr transfer_ref.txt
...
printf "\ntranslate test_0\n\n"
$SCRIPT/translate_yelp.sh $1 data/yelp/test_0.txt data/yelp/test_0.attr transfer_test0.txt
printf "\ntranslate test_1\n\n"
$SCRIPT/translate_yelp.sh $1 data/yelp/test_1.txt data/yelp/test_1.attr transfer_test1.txt
...
$SCRIPT/translate_yelp.sh $1 data/yelp/test.txt data/yelp/test.attr transfer_entire_test.txt
