...
if __name__ == '__main__':
    ...
    shen_dir = "data/yelp_shen"

    train0 = "data/yelp_shen/sentiment.train.0"
    train1 = "data/yelp_shen/sentiment.train.1"
    dev0 = "data/yelp_shen/sentiment.dev.0"
    dev1 = "data/yelp_shen/sentiment.dev.1"
    test0 = "data/yelp_shen/sentiment.test.0"
    test1 = "data/yelp_shen/sentiment.test.1"

    subprocess.run("cat {} {} {} {} {} {} > {}".format(train0, train1, 
    ...
    with open(os.path.join(shen_dir, "sentiment.train.0"), "r") as fin:
        for line in fin:
            ftrain_t.write(line)
            ftrain_a.write("negative\n")

    with open(os.path.join(shen_dir, "sentiment.train.1"), "r") as fin:
        for line in fin:
            ftrain_t.write(line)
    ...
    with open(os.path.join(shen_dir, "sentiment.dev.0"), "r") as fin:
        for line in fin:
            ftrain_t.write(line)
            ftrain_a.write("negative\n")

    with open(os.path.join(shen_dir, "sentiment.dev.1"), "r") as fin:
        for line in fin:
            ftrain_t.write(line)
            ftrain_a.write("positive\n")
    ...
    with open(os.path.join(shen_dir, "sentiment.test.0"), "r") as fin:
        for line in fin:
            ftrain_t.write(line)
            ftrain_a.write("negative\n")

    with open(os.path.join(shen_dir, "sentiment.test.1"), "r") as fin:
        for line in fin:
            ftrain_t.write(line)
            ftrain_a.write("positive\n")
