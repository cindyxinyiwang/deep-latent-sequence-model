...
./scripts/form_em/translate_form_em.sh $1 data/form_em/test.txt data/form_em/test.attr transfer_ref.txt
...
printf "\ntranslate test_0\n\n"
./scripts/form_em/translate_form_em.sh $1 data/form_em/test_0.txt data/form_em/test_0.attr transfer_test0.txt
printf "\ntranslate test_1\n\n"
./scripts/form_em/translate_form_em.sh $1 data/form_em/test_1.txt data/form_em/test_1.attr transfer_test1.txt
...
./scripts/form_em/translate_form_em.sh $1 data/form_em/test.txt data/form_em/test.attr transfer_entire_test.txt
