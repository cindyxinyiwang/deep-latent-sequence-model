...
$SCRIPT/translate_shakespeare.sh $1 data/shakespeare/test_0.txt data/shakespeare/test_0.attr transfer_modern.txt
...
$SCRIPT/translate_shakespeare.sh $1 data/shakespeare/test_1.txt data/shakespeare/test_1.attr transfer_shakespeare.txt
...
$SCRIPT/translate_shakespeare.sh $1 data/shakespeare/test.txt data/shakespeare/test.attr transfer_entire_test.txt
